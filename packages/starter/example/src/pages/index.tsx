...
const ReactUIWalletConnectButtonDynamic = dynamic(
    async () => (await import('@metadaoproject/wallet-adapter-react-ui')).WalletConnectButton,
    { ssr: false }
);
...
const ReactUIWalletModalButtonDynamic = dynamic(
    async () => (await import('@metadaoproject/wallet-adapter-react-ui')).WalletModalButton,
    { ssr: false }
);
